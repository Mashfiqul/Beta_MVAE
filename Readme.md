# Regularized mixtures of variational autoencoders model for cluster analysis

## Overview

This repository contains the code for the paper "Unsupervised Clustering Using a Variational Autoencoder with Constrained Mixtures for Posterior and Prior", which is currently under review. 
...
Our proposed mixtures VAE (MVAE(EM)) and constrained MVAE(EM) can be accessed in 'Proposed_Models' folder. The evaluated models (VAE, VADE, k-DVAE) can be accessed in 'Evaluated_Models' folder.
...
@article{chowdhury2024deep,
  title={Unsupervised Clustering Using a Variational Autoencoder with Constrained Mixtures for Posterior and Prior},
